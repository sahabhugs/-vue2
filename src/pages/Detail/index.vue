  ...
  <div class="detail">
    ...
    <section class="con">
      ...
      <div class="conPoin">
        ...
        <span v-show="categoryView.categor3Name">{{ categoryView.category3Name }}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                v-for="(spuSaleAttrValue,index) in spuSaleAttrValueList" 
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前咱们的路由跳转：从A路由跳转到B路由，这里在加入购物车，进行路由跳转之前，需要发请求
...
export default {
  ...
  computed: {
    ...
    //给子组件的数据
    skuImageList() {
      //如果服务器数据没有回来，那么这个skuInfo这个对象是个空对象 undefined
  ...
  methods: {
    ...
    async addShopCar() {
      ...
      //当前这里是已经派发了一个action，也向服务器发请求了
      //2.但是需要判断加入购物车是成功了还是失败了，进行相应的操作：如果成功进行路由跳转，如果失败则需要给用户提示
      try {
        //成功
